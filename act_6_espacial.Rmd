...
La idea acá es crear una base de datos spatialite para almacenar datos espaciales que corresponden a las localizaciones de escarabajos.
...
1. Crear una base de datos spatialite vacía desde qgis
1. Leer los archivos en R para enviarlos en la base de datos, como capas espaciales
1. Calcular las superficies de ecosistemas utilizando spatialite
1. Calcular el numero de eventos en cada habitar utilizando spatialite
1. ¡Comparar!