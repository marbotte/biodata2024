...
-- <distinct2>
SELECT DISTINCT ON (especie) *
FROM bogota_chingaza
ORDER BY especie,abundancia ASC
;
-- <distinct2 END>
...
SELECT DISTINCT ON (especie) *
FROM bogota_chingaza
ORDER BY especie,abundancia DESC
;
-- <distinct3 END>

-- <distinct4>
SELECT count(DISTINCT especie)
FROM bogota_chingaza
;
-- <distinct4 END>
...
-- <distinct5>
SELECT ARRAY_AGG(DISTINCT unidad_muestreo) distinct_array
FROM bogota_chingaza
;
-- <distinct5 END>

-- <undistinct5>
SELECT ARRAY_AGG(unidad_muestreo) array_lugar
FROM bogota_chingaza
;
-- <undistinct5 END>
...
SELECT *,
    CASE
        WHEN NOT sur_america THEN '¡Está lejos!'
